<x-layout>
    ...
    <x-card class="mb-8">
        <form action="{{route('my-jobs.store')}}" mrthod="POST">
            @csrf
            <div class="mb-4 grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    :options="array_combine(array_map('ucfirst', \App\Models\Job::$experience), \App\Models\Job::$experience)" :allOption="false"/>
                </div>
                <div>
                    <x-label for="category" :required="true">Category</x-label>
                    <x-radio-group name="category" :value="old('category')" 
                    :options="\App\Models\Job::$category" :allOption="false"/>
                </div>
                <div class="col-span-2">
